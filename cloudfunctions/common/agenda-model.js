...
function createEnglishLocale() {
  return {
    fixedContent: {
      ...
      clubSubtitle: '双语成长分享平台',
      charter: 'Charter information',
      meetingTime: '例会时间 Meeting time',
      venue: '会议地点 Meeting venue',
      fees: '费用信息 Fee information',
...
/**
 * 方法是什么：同步会议促进者报告人员。
 * 方法作用：把开场环节的角色人员复制到报告环节。
 * 为什么添加：编辑和报名写入人员后，相关流程必须保持一致。
 */
 ...
 * 方法作用：把已占用宾客接待槽位的人员写入议程实际展示的人员位置。
 * 为什么添加：报名槽位历史上只写入签到人员，导致议程数据两处不一致。
 */
